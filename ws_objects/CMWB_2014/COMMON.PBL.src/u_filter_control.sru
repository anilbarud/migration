$PBExportHeader$u_filter_control.sru
forward
global type u_filter_control from userobject
end type
type pb_next from picturebutton within u_filter_control
end type
type pb_previous from picturebutton within u_filter_control
end type
type pb_toggle_filter from picturebutton within u_filter_control
end type
type pb_filter_not_like from picturebutton within u_filter_control
end type
type pb_filter_like from picturebutton within u_filter_control
end type
end forward
...
global u_filter_control u_filter_control

type variables
public u_dw_online		idw_datawindow
end variables

forward prototypes
public function integer uf_set_requestor (u_dw_online adw_datawindow)
end prototypes

public function integer uf_set_requestor (u_dw_online adw_datawindow);idw_datawindow = adw_datawindow

return 1
end function

on u_filter_control.create
