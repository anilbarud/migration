$PBExportHeader$n_resize_splitter.sru
$PBExportComments$PFC Resize service
forward
global type n_resize_splitter from nonvisualobject
end type
end forward
...
global n_resize_splitter n_resize_splitter
...
Integer istr_registered_li_min_height[] 
...
istr_registered_li_widthmin[li_registered_slot] = 0
...
istr_registered_li_min_height[li_registered_slot] = 0 
...
Choose Case of_TypeOf(awo_control)
	Case DRAGOBJECT
		...
		li_width = ldrg_cntrl.Width
		li_height = ldrg_cntrl.Height
		li_min_height = integer(ldrg_cntrl.tag)
	Case LINE
...
IF li_min_height > 0 THEN 
	istr_registered_li_min_height[li_slot_available] = li_min_height
ELSE
	istr_registered_li_min_height[li_slot_available] = 0
END IF
...
on n_resize_splitter.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_resize_splitter.destroy
