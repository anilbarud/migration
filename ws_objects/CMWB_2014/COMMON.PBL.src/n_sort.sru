$PBExportHeader$n_sort.sru
forward
global type n_sort from nonvisualobject
end type
end forward
...
public function integer of_setrequestor (u_dw_online adw_requestor)
end prototypes
...
public function integer of_setrequestor (u_dw_online adw_requestor);STRING		ls_mod_string
