$PBExportHeader$n_dw_tooltip.sru
$PBExportComments$Non-Visual tooltip control object
forward
global type n_dw_tooltip from nonvisualobject
end type
type rect from structure within n_dw_tooltip
end type
type toolinfo from structure within n_dw_tooltip
end type
type point from structure within n_dw_tooltip
end type
type msg from structure within n_dw_tooltip
end type
type size from structure within n_dw_tooltip
end type
end forward
...
global n_dw_tooltip n_dw_tooltip

type prototypes
// ToolTip Functions
SubRoutine InitCommonControls() library "comctl32.dll"
//Function long CreateWindowExA(ulong dwExStyle, string ClassName, long WindowName, ulong dwStyle, ulong X, ulong Y, ulong nWidth, ulong nHeight, ulong hWndParent, ulong hMenu, ulong hInstance, ulong lpParam) library "user32.dll" Alias For "CreateWindowExA"
Function long CreateWindowExA(ulong dwExStyle, string ClassName, long WindowName, ulong dwStyle, ulong X, ulong Y, ulong nWidth, ulong nHeight, ulong hWndParent, ulong hMenu, ulong hInstance, ulong lpParam) library "user32.dll" Alias For "CreateWindowExA" Alias For "CreateWindowExA;Ansi"
...
on n_dw_tooltip.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_dw_tooltip.destroy
