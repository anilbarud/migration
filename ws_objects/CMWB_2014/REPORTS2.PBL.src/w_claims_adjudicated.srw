$PBExportHeader$w_claims_adjudicated.srw
$PBExportComments$Window to produce report of all non pension claims adjuducated within user specified time frame.
forward
global type w_claims_adjudicated from w_a_report
end type
type cb_ok from commandbutton within w_claims_adjudicated
end type
type gb_1 from groupbox within w_claims_adjudicated
end type
type dw_enter_date_range from u_dw_online within w_claims_adjudicated
end type
end forward

global type w_claims_adjudicated from w_a_report
boolean TitleBar=true
string Title="Non-Pension Claims Adjudicated"
cb_ok cb_ok
gb_1 gb_1
dw_enter_date_range dw_enter_date_range
end type
global w_claims_adjudicated w_claims_adjudicated
...
on w_claims_adjudicated.create
int iCurrent
...
on w_claims_adjudicated.destroy
...
type dw_report from w_a_report`dw_report within w_claims_adjudicated
int Y=493
int TabOrder=40
string DataObject="d_claims_adjudicated"
